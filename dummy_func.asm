...
_dummy_func:     file format elf32-i386
...
int main(int argc, char *argv[]) {
  ...
  1f:	8b 71 04             	mov    0x4(%ecx),%esi
  if(argc < 2)
  22:	83 ff 01             	cmp    $0x1,%edi
  25:	7f 68                	jg     8f <main+0x8f>
  else
	n = atoi(argv[1]);
  ...
  2b:	0f 84 94 00 00 00    	je     c5 <main+0xc5>
    {
      // parent
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  31:	e8 bd 03 00 00       	call   3f3 <getpid>
  36:	56                   	push   %esi
  for ( k = 0; k < n; k++ ) {
  37:	83 c7 01             	add    $0x1,%edi
      printf(1, "Parent %d creating child %d\n",getpid(), pid);
  3a:	50                   	push   %eax
  3b:	68 5c 08 00 00       	push   $0x85c
  40:	6a 01                	push   $0x1
  42:	e8 99 04 00 00       	call   4e0 <printf>
      wait();
  47:	e8 2f 03 00 00       	call   37b <wait>
  4c:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  4f:	39 df                	cmp    %ebx,%edi
  51:	7d 37                	jge    8a <main+0x8a>
    pid = fork ();
  53:	e8 13 03 00 00       	call   36b <fork>
    sleep(2);
  ...
  5d:	89 c6                	mov    %eax,%esi
    sleep(2);
  5f:	e8 9f 03 00 00       	call   403 <sleep>
    if ( pid < 0 ) 
  64:	83 c4 10             	add    $0x10,%esp
  67:	85 f6                	test   %esi,%esi
  69:	79 c0                	jns    2b <main+0x2b>
      printf(1, "%d failed in fork!\n", getpid());
  6b:	e8 83 03 00 00       	call   3f3 <getpid>
  70:	83 ec 04             	sub    $0x4,%esp
  for ( k = 0; k < n; k++ ) {
  73:	83 c7 01             	add    $0x1,%edi
      printf(1, "%d failed in fork!\n", getpid());
  76:	50                   	push   %eax
  77:	68 48 08 00 00       	push   $0x848
  7c:	6a 01                	push   $0x1
  7e:	e8 5d 04 00 00       	call   4e0 <printf>
  83:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  86:	39 df                	cmp    %ebx,%edi
  88:	7c c9                	jl     53 <main+0x53>
  ...
  exit();
  8a:	e8 e4 02 00 00       	call   373 <exit>
	n = atoi(argv[1]);
  8f:	83 ec 0c             	sub    $0xc,%esp
  92:	ff 76 04             	pushl  0x4(%esi)
  95:	e8 66 02 00 00       	call   300 <atoi>
  if (n < 0 ||n > 20)
  9a:	83 c4 10             	add    $0x10,%esp
	n = atoi(argv[1]);
  9d:	89 c3                	mov    %eax,%ebx
  if (n < 0 ||n > 20)
  9f:	83 f8 14             	cmp    $0x14,%eax
  a2:	76 45                	jbe    e9 <main+0xe9>
	  n = 2;
  a4:	bb 02 00 00 00       	mov    $0x2,%ebx
  if (argc < 3)
  a9:	83 ff 02             	cmp    $0x2,%edi
  ac:	0f 84 75 ff ff ff    	je     27 <main+0x27>
    priority = atoi(argv[2]);
  b2:	83 ec 0c             	sub    $0xc,%esp
  b5:	ff 76 08             	pushl  0x8(%esi)
  b8:	e8 43 02 00 00       	call   300 <atoi>
  bd:	83 c4 10             	add    $0x10,%esp
  c0:	e9 62 ff ff ff       	jmp    27 <main+0x27>
      sleep(2);
  c5:	83 ec 0c             	sub    $0xc,%esp
  c8:	6a 02                	push   $0x2
  ca:	e8 34 03 00 00       	call   403 <sleep>
      printf(1,"Child %d created\n",getpid());
  cf:	e8 1f 03 00 00       	call   3f3 <getpid>
  d4:	83 c4 0c             	add    $0xc,%esp
  d7:	50                   	push   %eax
  d8:	68 79 08 00 00       	push   $0x879
  dd:	6a 01                	push   $0x1
  df:	e8 fc 03 00 00       	call   4e0 <printf>
  e4:	83 c4 10             	add    $0x10,%esp
      for(z = 0; z < 4000000000; z+=1)
  e7:	eb fe                	jmp    e7 <main+0xe7>
  if (argc < 3)
  e9:	83 ff 02             	cmp    $0x2,%edi
  ec:	74 0e                	je     fc <main+0xfc>
    priority = atoi(argv[2]);
  ee:	83 ec 0c             	sub    $0xc,%esp
  f1:	ff 76 08             	pushl  0x8(%esi)
  f4:	e8 07 02 00 00       	call   300 <atoi>
  f9:	83 c4 10             	add    $0x10,%esp
  for ( k = 0; k < n; k++ ) {
  fc:	85 db                	test   %ebx,%ebx
  fe:	0f 85 23 ff ff ff    	jne    27 <main+0x27>
 104:	eb 84                	jmp    8a <main+0x8a>
 ...
 43c:	89 d1                	mov    %edx,%ecx
{
 ...
 469:	0f b6 92 94 08 00 00 	movzbl 0x894(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 664:	eb 1a                	jmp    680 <printf+0x1a0>
          s = "(null)";
 666:	bb 8b 08 00 00       	mov    $0x88b,%ebx
        while(*s != 0){
